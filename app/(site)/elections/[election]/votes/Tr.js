const Tr = ({ obj, idx }) => {
	...
	return (
		<tr className="py-10 even:bg-slate-50 odd:bg-gray-100 hover:bg-gray-200 font-medium">
			...
			<td className="px-2 py-2 md:px-4 md:py-4">{email || "ABC"}</td>
			<td className="px-2 py-2 md:px-4 md:py-4">250,000</td>
			<td className="px-2 py-2 md:px-4 md:py-4">{phone || "1,000,000"}</td>
			<td className="px-2 py-2 md:px-4 md:py-4">25%</td>
		</tr>
	);
};
